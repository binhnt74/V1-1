...
public class PSOSwarm {
	...
	public Map<Integer, Double> run(String serviceId) {
		...
		PSOParticle bestParticle = new PSOParticle(PSOParticle.FunctionType.A, "bestParticle", dim, mapRTable,
				rtable);
...
//				rtable);
	...
	private PSOParticle[] initialize() {
		...
		for (int i = 0; i < numOfParticles; i++) {
			...
			PSOParticle particle = new PSOParticle(PSOParticle.FunctionType.A, "p" + i, dim, mapRTable,
					rtable);
